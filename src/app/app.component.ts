...
/* como primer punto, aquí se está usando el subscribe en checkAuthentication que viene del servicio pero este checkAuthentication regresaba un Observable que emite un valor boolean o también podía regresar un boolean entonces ahí surge un primer problema porque checkAuthentication solo tendría que regresar un observable para usar el subscribe entonces sería mejor que checkAuthentication regrese un solo tipo de dato para evitar inconvenientes el cual sería que retorne un Observable que emite un valor boolean */
